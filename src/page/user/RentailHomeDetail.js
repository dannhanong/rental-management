...
class RentailHomeDetail extends Component {
    ...
    fetchRooms = async () => {
        try {
            ...
            const response = await axios.get(process.env.REACT_APP_BASE_URL+`/room/${id}`);
    ...
    fetchComments = async () => {
        try {
            const id = window.location.pathname.split("/").pop();
            const response = await axios.get(process.env.REACT_APP_BASE_URL+`/room/${id}/comments`);
    ...
    handleSubmitComment = async (event) => {
        ...
        try {
            ...
            const response = await axios.post(
                process.env.REACT_APP_BASE_URL+`/room/${roomId}/comments`,
                commentData,
                {
                    headers: {
