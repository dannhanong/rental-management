...
const Search = () => {
  ...
  const handleSearch = async () => {
    ...
    const response = await fetch(process.env.REACT_APP_BASE_URL+`/user/message/${username}`, {
      method: "GET",
      headers: {
  ...
  const handleSelect = async (user) => {
    try {
      ...
      const response = await fetch(process.env.REACT_APP_BASE_URL+`/user/message-chat/${userId}`, {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
        },
